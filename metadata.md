...
The metadata for the SPAdes assembly from 8M reads using the --careful --plasmid options is shown below:
  ...
  - The cleaned read names can then be used directly on the original read `fastq` files to output the presumptive plasmid reads **[Script 10](/scripts.md#scr10)** or to combine and exclude plasmid reads creating ***genomic*** read files **[Script 11](/scripts.md#scr11)**.
...
```
 ...
 SAM and BAM files were generated using Bowtie2 v. 2.3.4.1 
 
 The Bowtie2 process begins with and building and "inspection" of the reference genome, genome followed by alignment 
 of the reads to the reference genome, generating a `.SAM` file. Our reference genome was accession CP065737.1 throughout. **[Script 15](/scripts.md#15)
 
 The `.SAM` file was converted to a BAM file, sorted, and indexed by Samtools v. 1.10 **[Spript 16](/scripts.md#16)**
 
 If needed, a consensus sequence of the newly assembled genome can be generated by bcftools/1.8 and samtools/1.8 **[Script 17](/scripts.md#17)
