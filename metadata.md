...
```
 ...
 These comparisons used [CP065737.1](https://www.ncbi.nlm.nih.gov/nuccore/CP065737.1) as the reference genome. The N50 reflects the length of the contig at the midpoint when all contigs are aligned end-to-end in ascending or descending order based on length.
