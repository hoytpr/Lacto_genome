...
```
 ...
 The `.SAM` file was converted to a BAM file, sorted, and indexed by Samtools v. 1.10 **[Spript 16](/scripts.md#16)** and the `.BAM` file was submitted with a scaffolded contig assembly to NCBI as part of BioProject PRJNA731925.
