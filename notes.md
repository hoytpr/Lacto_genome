...
<a name="01"></a>
`Note 1.` [NexteraPE-PE-G.fa](/files/NexteraPE-PE-G.fa) is a **<mark>downloadable custom adapter removal file</mark>** designed to also remove poly(G) stretches of 35 consecutive G nucleotides (or more) in the reads data. Poly(G) stretches can occur with Illumina "two-color" technology sequencers (usually in read-2). 
